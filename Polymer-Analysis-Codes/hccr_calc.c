//  ROUTINE COMPUTES INTERMOLECULAR CENTER-OF-MASS/CENTER-OF-MASS
...
int main()
{
    ...
    char cord_[] = "bcom_ETHY_T453_96";               //  INPUT: BINARY SITE COORDINATES
    char dirn_[] = "HOFR_ETHY_T453_96/";              //  OUTPUT: RESULTS DIRECTORY
    char hofr_[] = "hccr_ETHY_T453_96";               //  OUTPUT: TOTAL COORELATION FUNCTION
